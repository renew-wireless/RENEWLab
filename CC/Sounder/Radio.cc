...
//    std::cout<< "stream now is "<< (flag_args & SOAPY_SDR_HAS_TIME)<<std::endl;
...
//    std::cout<<"flags before recv: "<<flags<<std::endl;
...
//    std::cout<<"flags after recv: "<<flags<<std::endl;

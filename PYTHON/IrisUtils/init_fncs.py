...
def agc_init(sdr, rssi_target_idx):
    ...
    sdr.writeRegister("IRIS30", FPGA_IRIS030_WR_IQ_THRESH, 1000)              # Saturation Threshold: 10300 about -6dBm
    sdr.writeRegister("IRIS30", FPGA_IRIS030_WR_NUM_SAMPS_SAT, 3)             # Number of samples needed to claim sat.
    sdr.writeRegister("IRIS30", FPGA_IRIS030_WR_MAX_NUM_SAMPS_AGC, 100)       # Threshold at which AGC stops
    ...
    sdr.writeRegister("IRIS30", FPGA_IRIS030_WR_AGC_SMALL_JUMP, 2)            # Drop gain at subsequent sat. detections
